		...
		<div class="container">
			<div class="row justify-content-lg-end align-items-center banner-content">
				<div class="col-lg-5">
					...
					<p>Le Scoutimse depuis Lord Robert Baden-Powell à ce jour</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="sample-text-area">
		<div class="container">
			<h3 class="text-heading">La genèse du mouvement scout</h3>
			<p class="sample-text">
			...
			<br>
			<h3 class="text-heading">Le mouvement scout au Bénin</h3>
			<p>
              C’est  bien plus tard entre 1928 et 1932 que  le Scoutisme arriva au Bénin à travers les missionnaires catholiques et protestants, les enseignants français de l’école supérieur Victor ballot et les Administrateurs français. Ils ont compris déjà à cette époque que le Scoutisme est complémentaire de la famille mais aussi et surtout de l’école. Et c’est dans cette dynamique que les premières unités  scoutes fut crées. 
                  ...
                  <br> 
                  <ul>
                    <li>  les Scouts Catholiques du Dahomey, </li>
                    <li>  les Eclaireurs et Eclaireuses du Dahomey, </li>
                    <li>  les Eclaireurs et Eclaireuses Unioniste du Dahomey,</li>
                    <li>  les Guides du Dahomey. </li>
                  </ul>
                  <br> 
