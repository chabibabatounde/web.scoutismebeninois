	...
	<section class="whole-wrap" style="background-color: white;">
		<div class="container">
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
							<form action="" method="GET">
								<input style="margin-top: 20px; width:99%; border:none; padding-bottom:05px; padding-top:05px;	 border-bottom: solid 1px black;"  name="find" placeholder="Saisir la référence">
				                  <br>
				                  <br>
			...
			?>
					...
					<form action="" method="GET">
						<input style="margin-top: 20px; width:99%; border:none; padding-bottom:05px; padding-top:05px;	 border-bottom: solid 1px black;"  name="find" placeholder="Saisir une nouvelle référence">
		                  <br>
		                  <br>
	                  	<button type="submit" class="button button-contactForm primary-btn">Vérifier la référence</button>
					</form>
