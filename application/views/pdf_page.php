...
<center>
	<br>
		<img src='<?php echo($cotisation['qrcode']) ?>'> </div>
	<h3>
	Veuillez patienter...
	<br>
	<br>
	votre téléchargement va démarrer automatiquement dans <span id='counter'>10</span> secondes.
	</h3>
</center>
...
document.addEventListener("DOMContentLoaded", () => {
	...
	setTimeout(function() {
	    if(ticket_data.qrcode.trim()!=""){
			doc.addImage(ticket_data.qrcode, 10, 130, 30, 30);
	    }
