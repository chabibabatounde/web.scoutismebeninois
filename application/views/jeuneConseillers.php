	...
	<section class="banner-area relative">
		...
		<div class="container">
			<div class="row justify-content-lg-end align-items-center banner-content">
				<div class="col-lg-5">
					<h1 class="text-white">Comité National des Jeunes Conseillers</h1>
					<p> </p>
				</div>
			</div>
		</div>
	...
	<section class="blog_area single-post-area section-gap">
	    <div class="container">
			<h3 class="text-heading">Comité National des Jeunes Conseillers</h3>
	      	<div class="row">
	      		<p> 
	      			Le Comité National des Jeunes Conseillers est le bureau du Forum National des Jeunes. Il est composé de sept membres élus au Forum National des Jeunes pour un mandat de trois ans non renouvelable.<br>
