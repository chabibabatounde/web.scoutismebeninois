...
class Web extends CI_Controller {
  ...
  file_put_contents($output, file_get_contents($compressed_url));
	...
	# sudo usermod -aG www-data scoutismebeninois
	# sudo chgrp -R www-data /home/scoutismebeninois/www
	# sudo chmod -R 775 /home/scoutismebeninois/www
		...
		if(true){
			...
			case 'index':
				if(isset($_POST['categorie'])){
				    ...
				    print_r($_FILES['coover-input']);
				    if(move_uploaded_file($_FILES['coover-input']["tmp_name"], $source)){
				    	// echo "<img src='".$_FILES['coover-input']["tmp_name"]."'>";
